...
@interface YBShowBigImageView ()<UIScrollViewDelegate>

@end

@implementation YBShowBigImageView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        imageView.frame = CGRectMake(0, 0, self.qmui_width, self.qmui_height);
