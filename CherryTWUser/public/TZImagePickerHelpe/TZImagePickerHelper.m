...
//         imagePickerVc.oKButtonTitleColorNormal = [UIColor greenColor];
    ...
    // 3. 设置是否可以选择视频/图片/原图
    imagePickerVc.allowPickingVideo = self.canChooseVideo;
...
//    }];
    ...
    imagePickerVc.barItemTextColor = HEXAlpha(#000000, 0.87f);
    [imagePickerVc.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName : HEXAlpha(#000000, 0.87f)}];
    imagePickerVc.navigationBar.tintColor = HEXAlpha(#000000, 0.87f);
    imagePickerVc.naviBgColor = HEX(#F3F3F3);;
    imagePickerVc.barItemTextColor = HEX(#4A90E2);
    imagePickerVc.barItemTextFont = MPBoldFont(17);
    // 自定义导航栏上的返回按钮
    ...
    imagePickerVc.navigationBar.backgroundColor = THEAME_COLOR;
    imagePickerVc.naviTitleColor = [UIColor clearColor];
#pragma mark - 到这里为止
...
- (void)imagePickerController:(TZImagePickerController *)picker didFinishPickingVideo:(UIImage *)coverImage sourceAssets:(PHAsset *)asset
{
    ...
    if ([asset isKindOfClass:[AVURLAsset class]]) {
        ...
        self.finishChooseVideo(coverImage, urlAsset.URL);
     }
    }];
}
