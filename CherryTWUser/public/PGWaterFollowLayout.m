...
/** 默认的列数*/
static const NSInteger PGDefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger PGDefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger PGDefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat PGDefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets PGDefaultEdgeInset = {10, 10, 10, 10};

///** 每一行之间的间距*/
//static const CGSize PGDefaultHeaderSize = CGSizeMake(0, 66);
///** 每一行之间的间距*/
//static const CGSize PGDefaultFooterSize = CGSizeMake(0, 66);

@interface PGWaterFollowLayout ()
...
@implementation PGWaterFollowLayout

-(CGFloat)columnMargin {
    if ([self.delegate respondsToSelector:@selector(columnMarginInWaterFlowLayout:)]) {
        return [self.delegate columnMarginInWaterFlowLayout:self];
    } else {
        return  PGDefaultColumeMargin;
    }
}
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == PGWaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == PGWaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == PGWaterFlowVerticalEqualHeight || self.flowLayoutStyle == PGLineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == PGWaterFlowHorizontalGrid){
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(self.flowLayoutStyle == PGWaterFlowVerticalEqualHeight){
        
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
        
    }else if(self.flowLayoutStyle == PGLineWaterFlow){
...
/*
 ...
 {
 if (self.flowLayoutStyle == PGLineWaterFlow) {
