...
#else
    NSString *url = [NSString stringWithFormat:@"wss://main.stelor.cn/chatserver/presence/user/%@?token=%@",[PGManager shareModel].userInfo.userid,[PGManager shareModel].userInfo.loginToken];
#endif
